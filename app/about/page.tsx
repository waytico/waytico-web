      ...
      <main className="flex-1">
        <article className="max-w-3xl mx-auto px-4 py-12 md:py-16 space-y-6">
          ...
          <p className="text-foreground/80 leading-relaxed">
            ...
            proposal page your client can open on any device. When the client says yes and pays,
            that same page becomes the place where the whole trip lives — what to bring, what&apos;s
            booked, what&apos;s coming next.
          </p>
          <p className="text-foreground/80 leading-relaxed">
            One link. One page. From first pitch to day-of logistics.
          </p>
          ...
          <p className="text-foreground/80 leading-relaxed">
            <strong className="font-semibold text-foreground">
              You shouldn&apos;t pay rent to software.
            </strong>{' '}
            Quotes are free and unlimited. You only pay when a trip becomes real — when a client
            books and you activate the page. No subscription, no seat fees, no per-proposal charges.
          </p>
          ...
          <p className="text-foreground/80 leading-relaxed">
            Today Waytico handles the core loop: describe, propose, activate, run. Soon:
            multi-language proposals so you can sell in your client&apos;s language, document upload
            so your existing bookings and vouchers flow in automatically, and email reminders so
            clients actually show up prepared.
          </p>
          <p className="text-foreground/80 leading-relaxed">
